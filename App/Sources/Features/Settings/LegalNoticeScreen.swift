                ...
                BLCard {
                    VStack(alignment: .leading, spacing: Spacing.s4) {
                        ...
                        LegalSection("2. 수집하는 정보", [
                            ...
                            "동네 기능(중고 마켓·동네 크루) 사용 시: 사용자가 직접 정한 닉네임, 작성한 글·댓글·채팅, 동네 이름(예: ○○동), 기기 식별자가 백엔드(Supabase)에 저장됩니다.",
                            "로그인(선택) 시: Apple이 제공하는 로그인 식별자만 보관합니다. 실명·이메일을 닉네임으로 자동 저장하지 않습니다.",
                            "위치: 주변 병원·약국·시설 검색 시 기기의 현재 정확한 위치를 사용하며, 이 좌표는 검색 그 순간에만 쓰이고 저장하지 않습니다. 다만 동네 기능에서는 글을 올린 동네 이름(대략적 지역)이 위와 같이 서버에 저장됩니다.",
                        ])
