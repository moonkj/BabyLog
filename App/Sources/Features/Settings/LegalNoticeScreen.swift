                ...
                BLCard {
                    VStack(alignment: .leading, spacing: Spacing.s4) {
                        ...
                        LegalSection("1. 가장 중요한 약속", [
                            ...
                            "예외는 하나입니다 — 사용자가 직접 ‘가족과 공유’를 선택한 사진·영상만, 초대한 가족이 함께 볼 수 있도록 가족 보관함(클라우드)에 올라갑니다.",
                        ...
                        LegalSection("2. 수집하는 정보", [
                            ...
                            "가족과 사진 공유(선택 기능): 사용자가 공유하기로 한 사진·영상이 가족 보관함 서버(Cloudflare R2)에 저장되어, 초대·승인된 가족 구성원만 볼 수 있습니다. 가족이 남긴 하트·댓글과 가족 구성원의 표시 이름(성함)도 함께 저장됩니다.",
                        ...
                        LegalSection("3. 제3자 서비스 및 인프라", [
                            ...
                            "서비스 운영 인프라: 동네·가족 공유 백엔드는 Supabase, 가족 사진·영상 저장과 가족용 웹 페이지는 Cloudflare(R2·Pages), 푸시 알림은 Apple APNs, 개인 백업은 사용자 본인의 Apple iCloud를 이용합니다.",
